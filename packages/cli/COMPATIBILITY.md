...
gate, which drives **540 of the 547 leaves** and parses each one's stdout, and
...
the 540 leaves the gate drives. And on every terminal path — `--help`,
...
**413 of the 547 leaves** carry a derived shape line on their `--help`, generated
...
547 leaves, **0 unclassified, 0 stale**, 64 classified `safe`.
