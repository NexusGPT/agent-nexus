 ...
 *
 * `commands/apps-starter.ts` cannot import `@nexus/types` at runtime (the CLI
...
import { APP_STARTER_UI_VERSION_HEADER, APP_STARTER_VERSION_HEADER } from "./commands/apps-starter";
