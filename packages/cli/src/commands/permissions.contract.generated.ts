...
export const PERMISSIONS_GRANT_CONTRACT = {
  ...
  fields: [
    { path: "Body.resourceType", slot: "Body", type: "string", required: true, depth: 0, enumValues: ["agent", "workflow", "knowledge", "credential", "access_card", "template", "document", "deployment", "feature", "vibe_app", "workspace"] },
...
export const PERMISSIONS_LIST_RESOURCE_ACCESS_CONTRACT = {
  ...
  fields: [
    { path: "PathVars.resourceType", slot: "PathVars", type: "string", required: true, depth: 0, enumValues: ["agent", "workflow", "knowledge", "credential", "access_card", "template", "document", "deployment", "feature", "vibe_app", "workspace"] },
